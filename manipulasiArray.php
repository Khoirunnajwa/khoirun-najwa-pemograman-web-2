...
$hasil = array_push($hari, "kamis", "Jumat"); //menambahka beberapa elemen pada akhir array
print_r($hari);
echo "<hr>";
...
$hasil = array_unshift($hari, "elemen", "ditambahkan"); //menambahkan beberapa elemen pada array
print_r($hari);
